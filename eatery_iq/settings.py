"""
Django settings for eatery_iq project.
"""
...
# Security Settings
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-6fc22*wly4-b)im=b9#9r11*1gsx454vl(%n=#@3*aj)#*ka**')
...
ROOT_URLCONF = 'eatery_iq.urls'
WSGI_APPLICATION = 'eatery_iq.wsgi.application'
